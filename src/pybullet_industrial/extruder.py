...
class RayCaster(EndeffectorTool):
    ...
    def __init__(self, urdf_model: str, start_position, start_orientation, raycast_properties: Dict, coupled_robots=None, tcp_frame=None, connector_frames=None):
        """Special Endeffector Tool which can cast rays.
...
class Extruder(RayCaster):
    ...
    def __init__(self, urdf_model: str, start_position, start_orientation, extruder_properties: Dict,
        ...
        Raises:
            ValueError: If no material is provided during initialization.
        """
        raycaster_properties = dict(extruder_properties)
        del raycaster_properties['material']
        del raycaster_properties['material properties']
        super().__init__(urdf_model, start_position, start_orientation, raycaster_properties,
                         coupled_robots, tcp_frame, connector_frames)
