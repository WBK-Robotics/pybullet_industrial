...
def loadURDF(fileName:str, basePosition:list[float]=None, baseOrientation:list[float]=None, useMaximalCoordinates:int=0, useFixedBase:bool=False, flags:int=0, globalScaling:float=1.0, physicsClientId:int=0): # real signature unknown; restored from __doc__
    """
...
def resetJointStatesMultiDof(objectUniqueId:int, jointIndices:list[int], targetValues:list[int], targetVelocities:list[int], physicsClientId:int=0): # real signature unknown; restored from __doc__
    """
