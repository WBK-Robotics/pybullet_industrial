...
if __name__ == "__main__":
    ...
    urdf_robot = os.path.join(
        working_dir, 'robot_descriptions', 'igus_4dof_robot.urdf')
    ...
    p.resetDebugVisualizerCamera(
        cameraDistance=0.5, cameraYaw=50.0,
        cameraPitch=-30,
        cameraTargetPosition=np.array([0.2, 0, 0.2]) + start_pos)
