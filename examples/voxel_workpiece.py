...
uvs = [[0.750000, 0.250000], [1.000000, 0.250000], [1.000000, 0.000000], [0.750000, 0.000000],
       [0.500000, 0.250000], [0.250000, 0.250000], [
           0.250000, 0.000000], [0.500000, 0.000000],
       [0.500000, 0.000000], [0.750000, 0.000000], [
           0.750000, 0.250000], [0.500000, 0.250000],
    ...
    for y in range(32):
        for z in range(10):
            batchPositions.append(
                [x * meshScale[0] * 2, y * meshScale[1] * 2, (0.0 + z) * meshScale[2] * 2])

bodyUids = p.createMultiBody(baseMass=0.1,
